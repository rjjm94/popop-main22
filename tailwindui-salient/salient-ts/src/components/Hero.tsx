  ...
  return (
    ...
    <span className="relative">Because you&apos;re in CNTRL</span>
        ...
        <div className="mt-10 flex justify-center gap-x-6  ">
            <Button className="rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-blue-600 text-white hover:text-slate-100 hover:bg-blue-500 active:bg-blue-800 active:text-blue-100 focus-visible:outline-blue-600" href="/register">Join the BETA</Button>
            <Button
